    ...
    if (this.props.errorsAtInit) {
      ...
      this.setState({
        ...
        message:
          ...
          'tbSIEM API not reachable, please review your configuration',
        fetchingData: false
      });
    }
  }
    ...
    try {
      ...
      const options = {
        ...
        error: {
          ...
          title: `tbSIEM API not reachable, please review your configuration: ${error.message || error}`,
        },
      };
    ...
    const editConfigChildren = (
      <div>
        ...
        <EuiText>
          ...
          <EuiCode>{'<api_url>'}</EuiCode> is the URL of the tbSIEM API,{' '}
