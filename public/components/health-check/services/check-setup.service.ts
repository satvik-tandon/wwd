...
import { PLUGIN_APP_NAME, PLUGIN_PLATFORM_WAZUH_DOCUMENTATION_URL_PATH_UPGRADE_PLATFORM } from '../../../../common/constants';
  ...
  if (currentApi && currentApi.id) {
    ...
    if (!apiVersion) {
      ...
      if (
        ...
        checkLogger.error(`tbSIEM API and ${PLUGIN_APP_NAME} version mismatch. API version: ${apiVersion}.`);
      }
    }
  }
