...
export const WzMenu = withWindowSize(class WzMenu extends Component {
  ...
  render() {
    ...
    const logotypeURL = getHttp().basePath.prepend(this.wazuhConfig.getConfig()['customization.logo.app'] ? getAssetURL(this.wazuhConfig.getConfig()['customization.logo.app']) : getThemeAssetURL('tbSIEM_logo.jpg'));
    const mainButton = (
